module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    uglify: {
      dist: {
        files: {
          'assets/js/scripts.min.js': ['assets/js/modernizr-output.js', 'assets/js/scripts.js']
        }
      }
    },
    uncss: {
      dist: {
        ...
        files: {
          'assets/css/styles.min.css': ['_site/index.html', '_site/speakers.html', '_site/agenda.html']
        }
      }
    },
    shell: {
    ...
    concat: {
      serve: {
        src: ['assets/js/modernizr-output.js', 'assets/js/scripts.js'],
  ...
  grunt.registerTask('default', ['sass_import','sass', 'autoprefixer', 'cssmin', 'modernizr', 'uglify']);
